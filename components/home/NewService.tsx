    ...
    return (
      <div className="my-20 w-full max-w-6xl mx-auto px-2">
        ...
        <div className="flex flex-row gap-4 flex-wrap font-semibold text-sm">
          <Link href="/" className="hover:text-sky-500">Home Improvement</Link>
          <Link href="/" className="hover:text-sky-500">Home Re-Modeling</Link>
          <Link href="/" className="hover:text-sky-500">Weddings</Link>
          <Link href="/" className="hover:text-sky-500">Events</Link>
          <Link href="/" className="hover:text-sky-500">More...</Link>
        </div>
      </div>
    );
}
