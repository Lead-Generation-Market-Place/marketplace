    ...
    supabase.auth.signInWithOAuth({
      ...
      options: {
        redirectTo: `${redirectTo}?priceId=${encodeURIComponent(
          ...
          discountCode || ""
        )}&redirect=${encodeURIComponent("/about")}`,
      },
    });
    setLoading(false);
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-10">
          {magicLinkState?.success ? (
            <div className="p-6 text-center bg-green-50 rounded-[6px]">
            ...
            <div className="space-y-6">
              <form action={magicLinkAction} className="space-y-4">
                <Input
                  ...
                  required
                  className="px-4 h-12 bg-white rounded-[4px] border-gray-200 shadow-sm transition-colors focus:border-blue-500 focus:ring-blue-500"
                />
                ...
                <Button
                  type="submit"
                  className="w-full h-12 font-medium text-white bg-[#0077B6] hover:bg-[#0096C7] rounded-[6px] transition-colors  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                >
                  {pending ? (
              ...
              <Button
                ...
                className="w-full h-12 font-medium text-gray-700 bg-white rounded-[6px] border border-gray-200 shadow-sm transition-all hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
              >
                {loading ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
          ...
          <p className="mt-4 text-sm text-center text-gray-600">
            ...
            <Link
              ...
              className="font-medium text-[#0077B6] hover:text-[#0096C7]"
            >
