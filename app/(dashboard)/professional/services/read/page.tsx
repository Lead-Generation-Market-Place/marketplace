...
const SearchServices = React.lazy(() => import("@/components/dashboard/professional/services/read/page"));
...
const ParentComponent: FC = () => {
  return (
    <main className="  dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-6">
